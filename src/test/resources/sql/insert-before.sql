truncate table "hibernate".public.house_owner cascade;

truncate table "hibernate".public.persons cascade;
select setval('"hibernate".public.persons_id_seq', 1, false);

truncate table "hibernate".public.houses cascade;
select setval('"hibernate".public.houses_id_seq', 1, false);
